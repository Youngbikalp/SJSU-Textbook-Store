...
<div class="top">
	...
	<div class="navbar">
		<a href="./initial_homepage.jsp">Home</a> <ahref="./books_display_guest.jsp">Books</a>
...
<!-- This form is brought up when a user tries to register with a username that is currently in the database -->
<body>
	<div class="section1">
		<p>Please select a different username.</p>
		...
		<form id="signup" class="input-group"
			...
			<button type="submit" class="submit-btn" name="signup" value="Signup" onclick="myFucntion()">Register</button>
		</form>
	...
	<%//Used to check if username is in the database 
